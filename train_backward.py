...
def main():
    ...
    parser.add_argument(
        "--game", type=str, default="sokoban", help="Game name (default: sokoban)"
    )
    parser.add_argument(
        "--representation",
        type=str,
    ...
    parser.add_argument(
        "--checkpoint-freq", type=int, default=5000, help="Checkpoint save frequency"
    )
    parser.add_argument(
        "--eval-freq", type=int, default=2000, help="Evaluation frequency"
    )
    parser.add_argument(
        "--n-eval-episodes", type=int, default=10, help="Number of evaluation episodes"
    )
    parser.add_argument(
